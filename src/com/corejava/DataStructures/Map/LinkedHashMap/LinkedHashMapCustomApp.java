...
/**
 * This class provides custom implementation of LinkedHashMap(without using 
 * java api's)- which allows us to store data in key-value pair form.
...
{     
     ...
     * If the map already contains a mapping for the key, the old value is 
     * replaced.
     * Note: method does not allows you to put null key thought it allows 
     * null values.
