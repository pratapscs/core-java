...
/**
* How HashSet implements hashing?
* Method internally uses HashMap’s hash method for hasihng.
* 
* This class provides custom implementation of HashSet(without using java 
* api's- we will be using HashMapCustom)- which allows does not allow you 
...
class HashSetCustom<E>
{
    ...
    /** How contains method works internally?
 ...
 /**
 * This class provides custom implementation of HashMap(without using java 
 * api's)- which allows us to store data in key-value pair form..
 * @param <K>
 * @param <V>
 */
