...
* Employee1 class- to be used as key in HashSetCustom.
*/
class Employee1 {
    private String id;
    private String name;
...
public class LinkedHashSetCustomEmp {
    ...
    public static void main(String[] args) {
           ...
           LinkedHashSetCustom<Employee1> linkedHashSetCustom = new LinkedHashSetCustom<Employee1>();
       linkedHashSetCustom.add(new Employee1("10", "sam"));
       linkedHashSetCustom.add(new Employee1("21", "amy"));
       linkedHashSetCustom.add(new Employee1("31", "rob"));
       linkedHashSetCustom.add(new Employee1("41", "sam"));
       linkedHashSetCustom.add(new Employee1("42", "wil"));
      
           System.out.println("LinkedHashSetCustom contains Employee1 with id=21 & name='amy' : "+linkedHashSetCustom.contains(new Employee1("21", "amy")));
           System.out.println("LinkedHashSetCustom contains Employee1 with id=51 & name='pat' : "+linkedHashSetCustom.contains(new Employee1("51", "pat")));
           
        System.out.print("Displaying : ");
        linkedHashSetCustom.display();
       
        System.out.println("\n\nEmployee1 with id=21 & name='amy' removed: "+linkedHashSetCustom.remove(new Employee1("21", "amy")));
        System.out.println("Employee1 with id=51 & name='pat' removed: "+linkedHashSetCustom.remove(new Employee1("51", "pat")));
