...
public class EmployeeOverride 
{
    public static void main(String...a)
    {
           ...
           hm.put(new Employee(1,"pratap"), "employee1 data");
           hm.put(new Employee(2,"chitti"), "employee2 data");
           
           System.out.println("HashMap's data> "+hm);
           System.out.println(hm.get(new Employee(1,"pratap")));
           
           hm.put(new Employee(1,"pratap"), "employee1 data OVERRIDDEN");
           
           System.out.println("\nAgain display HashMap after overriding data "+
                        "of Employee with id=1 and name=’pratap’\n");
